...
<script src="../../../JS/jQueryCookies.js"></script>
...
if(!isset($_COOKIE[$cookie_name])) {
     echo "<h4 id='Cookies'>Cookie for '" . $cookie_name . "' is not set!</h4>";
} else {
     echo "<h4 id='Cookies'>Cookie for '" . $cookie_name . "' is set!<br></h4>";
     echo "<h4 id='Cookies2'>User Name: " . $_COOKIE[$cookie_name];
}
?>
</div>
<p id="mytext"></p>
